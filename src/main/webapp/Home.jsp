...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
      ...
      .carousel-item:nth-child(1) {
        background-image: url('images/banner-bitis.jpg');
      ...
      .carousel-item:nth-child(2) {
        background-image: url('images/banner-nike.jpg');
        background-size: 100% 100%;
        background-position: center center;
      }
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:auto; width:120px; margin: auto;" src="https://theme.hstatic.net/200000078815/1001045559/14/support_2_ic_medium.png?v=261" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title" style="text-align:center">DỄ DÀNG ĐỔI TRẢ</h5>
      <p class="card-text" style="text-align:center">Đổi hàng nhanh chóng trong vòng 30 ngày</p>
    </div>
  </div>
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:auto; width:120px; margin: auto;" src="https://theme.hstatic.net/200000078815/1001045559/14/support_3_ic_medium.png?v=261" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title" style="text-align:center">CAM KẾT CHÍNH HÃNG</h5>
      <p class="card-text" style="text-align:center">Được bán trực tiếp từ cửa hàng chính hãng</p>
    </div>
  </div>
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:auto; width:120px; margin: auto;" src="https://theme.hstatic.net/200000078815/1001045559/14/support_4_ic_medium.png?v=261" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title" style="text-align:center">CSKH BẢO HÀNH</h5>
      <p class="card-text" style="text-align:center">Hotline: 0905 38 69 xx</p>
    </div>
  </div>
</div>
