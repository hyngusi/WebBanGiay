...
<div id="logreg-forms">
            <form class="form-signin" action="forgotPassword" method="post">
                ...
                <input name="username" type="text" id="username" class="form-control" placeholder="Tên tài khoản" required="" autofocus="">
                <input name="email" type="text" id="email" class="form-control" placeholder="Email" required="" autofocus="">
                <button class="btn btn-success btn-block" type="submit"><i class="fas fa-sign-in-alt"></i> Lấy mật khẩu</button> 
            </form>
